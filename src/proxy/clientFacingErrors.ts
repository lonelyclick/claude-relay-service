...
export const RELAY_ERROR_CODES = {
  BAD_REQUEST: 'COR_BAD_REQUEST',
  UNAUTHORIZED: 'COR_UNAUTHORIZED',
  PAYMENT_REQUIRED: 'COR_PAYMENT_REQUIRED',
  FORBIDDEN: 'COR_FORBIDDEN',
  ROUTE_NOT_FOUND: 'COR_ROUTE_NOT_FOUND',
  METHOD_NOT_ALLOWED: 'COR_METHOD_NOT_ALLOWED',
  PAYLOAD_TOO_LARGE: 'COR_PAYLOAD_TOO_LARGE',
  RATE_LIMITED: 'COR_RATE_LIMITED',
  INTERNAL_ERROR: 'COR_INTERNAL_ERROR',
  SERVICE_UNAVAILABLE: 'COR_SERVICE_UNAVAILABLE',
  PROVIDER_ROUTE_UNSUPPORTED: 'COR_PROVIDER_ROUTE_UNSUPPORTED',
  PROVIDER_WS_UNSUPPORTED: 'COR_PROVIDER_WS_UNSUPPORTED',
  OVERLOADED: 'COR_OVERLOADED',
  UNSUPPORTED_CLIENT: 'COR_UNSUPPORTED_CLIENT',
  UNSUPPORTED_CLIENT_VERSION: 'COR_UNSUPPORTED_CLIENT_VERSION',
  INVALID_FORCE_ACCOUNT: 'COR_INVALID_FORCE_ACCOUNT',
  RELAY_USER_REJECTED: 'COR_RELAY_USER_REJECTED',
  BILLING_INSUFFICIENT_BALANCE: 'COR_BILLING_INSUFFICIENT_BALANCE',
  BILLING_RULE_MISSING: 'COR_BILLING_RULE_MISSING',
  BODY_TOO_LARGE: 'COR_BODY_TOO_LARGE',
  ROUTING_GROUP_UNAVAILABLE: 'COR_ROUTING_GROUP_UNAVAILABLE',
  ROUTING_GUARD_LIMIT: 'COR_ROUTING_GUARD_LIMIT',
  SCHEDULER_CAPACITY: 'COR_SCHEDULER_CAPACITY',
  ACCOUNT_NOT_FOUND: 'COR_ACCOUNT_NOT_FOUND',
  ACCOUNT_UNAVAILABLE: 'COR_ACCOUNT_UNAVAILABLE',
  ACCOUNT_RATE_LIMITED: 'COR_ACCOUNT_RATE_LIMITED',
  ACCOUNT_POOL_UNAVAILABLE: 'COR_ACCOUNT_POOL_UNAVAILABLE',
  ACCOUNT_POOL_RATE_LIMITED: 'COR_ACCOUNT_POOL_RATE_LIMITED',
  UPSTREAM_CONFIG_UNAVAILABLE: 'COR_UPSTREAM_CONFIG_UNAVAILABLE',
  UPSTREAM_INCIDENT_ACTIVE: 'COR_UPSTREAM_INCIDENT_ACTIVE',
} as const
