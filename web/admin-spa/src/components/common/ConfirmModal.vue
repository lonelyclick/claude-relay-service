<template>
  <Teleport to="body">
    <div v-if="show" class="modal fixed inset-0 z-50 flex items-center justify-center p-4">
      <div
        class="modal-content mx-auto w-full max-w-md rounded-lg bg-white p-6 shadow-md dark:bg-gray-800"
      >
        ...
        <div class="flex gap-3">
          ...
          <button
            :class="[
              'flex-1 rounded-lg px-4 py-2.5 font-medium text-white shadow-sm transition-colors',
              type === 'danger'
